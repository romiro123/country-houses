...
// Аккордеон инициализация и настройки
...
// Аккордеон Вызов и передача
// import { AccordionLists } from '../functions/accordion-lists';
// AccordionLists(['.accordion--features']);

// подсказки в ввиде tippy
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _functions_accordion_list__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../functions/accordion-list */ "./src/js/functions/accordion-list.js");

(0,_functions_accordion_list__WEBPACK_IMPORTED_MODULE_0__.AccordionList)(['.accordion--features']);
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectCoverflow, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectCreative]);
...
const swiperStage = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".swiper--stage", {
  grabCursor: true,
  effect: "creative",
  creativeEffect: {
    prev: {
  ...
  pagination: {
    ...
    renderBullet: function (index, t1) {
      return '<li class="stage__pagination-item ' + t1 + '">' + `${'0' + (index + 1)}` + '<span class="stage__pagination-text"> Этап' + '</span>' + '</li>';
    }
  }
});
...
const afterForm = () => {
  //вызов модального окна с инф о успешной отправки формы
  document.getElementById('success-form').click();
};
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.form--service', rulesService, afterForm);
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.form--gallery', rulesGallery, afterForm);
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.form--modal', rulesModal, afterForm);

/***/ }),

/***/ "./src/js/functions/accordion-list.js":
/*!********************************************!*\
  !*** ./src/js/functions/accordion-list.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AccordionList: () => (/* binding */ AccordionList)
/* harmony export */ });
/* harmony import */ var accordion_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! accordion-js */ "./node_modules/accordion-js/dist/accordion.min.js");
/* harmony import */ var accordion_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(accordion_js__WEBPACK_IMPORTED_MODULE_0__);

const AccordionList = function () {
...
const validateForms = (selector, rules, afterSend) => {
  ...
  validation.onSuccess(ev => {
    ...
    //после подключения отправки на почту убрать этот вызов функции
    afterSend();
    ev.target.reset();
  });
};
